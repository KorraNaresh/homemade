...
public class Order {
	...
	public Order(Long id, String orderId, Customer customer, List<OrderItem> orderItems, LocalDateTime orderDate,
			LocalDateTime deliveryDate, Address shippingAddress, PaymentDetails paymentDetails, double totalPrice,
			double finalPrice, double discounte, OrderStatus orderStatus, int totalItem, LocalDateTime createdAt) {
		super();
		this.id = id;
		this.orderId = orderId;
		this.customer = customer;
